...
class TestMemoryCache(unittest.TestCase):
    ...
    def test_nonbib_record(self):
        ...
        n = process.convert(d)
        self.maxDiff = None
        a = {"read_count": 4, "bibcode": "2003ASPC..295..361M", "data_links_rows": [{"url": ["http://articles.adsabs.harvard.edu/pdf/2003ASPC..295..361M"], "link_type": "ESOURCE", "link_sub_type": "ADS_PDF"}, {"url": ["http://articles.adsabs.harvard.edu/full/2003ASPC..295..361M"], "link_type": "ESOURCE", "link_sub_type": "ADS_SCAN"}, {"url": [""], "link_type": "TOC", "link_sub_type": "NA"}], "esource": ["ADS_PDF", "ADS_SCAN"], "property": ["ADS_OPENACCESS", "ARTICLE", "ESOURCE", "NOT REFEREED", "OPENACCESS", "TOC"], "boost": 0.15, 'citation_count': 0, 'norm_cites': 0}
        self.assertEqual(a, n)

        # d = process.read_next_bibcode('2004MNRAS.354L..31M')
        # n = process.convert(d)
        # a = {"simbad_objects": ["3253618 G"], "read_count": 19, "bibcode": "2004MNRAS.354L..31M", "data_links_rows": [{"url": ["2004MNRAS.354L..31M", "2005yCat..73549031M"], "title": ["Source Paper", "Catalog Description"], "link_type": "ASSOCIATED", "link_sub_type": "NA"}, {"url": ["http://$VIZIER$/viz-bin/VizieR?-source=J/MNRAS/354/L31"], "title": [""], "item_count": 1, "link_type": "DATA", "link_sub_type": "CDS"}, {"url": ["https://$NED$/cgi-bin/objsearch?search_type=Search&refcode=2004MNRAS.354L..31M"], "title": ["NED Objects (1953)"], "item_count": 1953, "link_type": "DATA", "link_sub_type": "NED"}, {"url": ["http://$SIMBAD$/simbo.pl?bibcode=2004MNRAS.354L..31M"], "title": ["SIMBAD Objects (1)"], "item_count": 1, "link_type": "DATA", "link_sub_type": "SIMBAD"}, {"url": ["http://$VIZIER$/viz-bin/VizieR?-source=J/MNRAS/354/L31"], "title": [""], "item_count": 1, "link_type": "DATA", "link_sub_type": "Vizier"}, {"url": ["http://articles.adsabs.harvard.edu/pdf/2004MNRAS.354L..31M"], "link_type": "ESOURCE", "link_sub_type": "ADS_PDF"}, {"url": ["http://articles.adsabs.harvard.edu/full/2004MNRAS.354L..31M"], "link_type": "ESOURCE", "link_sub_type": "ADS_SCAN"}, {"url": ["https://arxiv.org/abs/astro-ph/0405472"], "link_type": "ESOURCE", "link_sub_type": "EPRINT_HTML"}, {"url": ["https://arxiv.org/pdf/astro-ph/0405472"], "link_type": "ESOURCE", "link_sub_type": "EPRINT_PDF"}, {"url": ["http://dx.doi.org/10.1111/j.1365-2966.2004.08374.x"], "link_type": "ESOURCE", "link_sub_type": "PUB_HTML"}, {"url": ["https://academic.oup.com/mnras/pdf-lookup/doi/10.1111/j.1365-2966.2004.08374.x"], "link_type": "ESOURCE", "link_sub_type": "PUB_PDF"}, {"url": ["http://inspirehep.net/search?p=find+j+MNRAA,354,L31"], "link_type": "INSPIRE", "link_sub_type": "NA"}], "norm_cites": 10000, "data": ["CDS:1", "NED:1953", "SIMBAD:1", "Vizier:1"], "citation_count_norm": 49.5, "citation_count": 99, "property": ["ASSOCIATED", "DATA", "ESOURCE", "INSPIRE", "ARTICLE", "REFEREED", "PUB_OPENACCESS", "ADS_OPENACCESS", "EPRINT_OPENACCESS", "OPENACCESS"], , "total_link_counts": 1956, "esource": ["ADS_PDF", "ADS_SCAN", "EPRINT_HTML", "EPRINT_PDF", "PUB_HTML", "PUB_PDF"], "boost": 0.4399999976158142}
        # self.assertEqual(a, n)
...
#                    {"url": ["http://$VIZIER$/viz-bin/VizieR?-source=J/MNRAS/354/L31"], "title": [""], "item_count": 1, "link_type": "DATA", "link_sub_type": "Vizier"},
